...
class HotalResortController extends Controller
{
    public function index(Request $request)
    {
        if ($request->searching_filter == "searching") {
            ...
            return view('front.hotels_and_resort.kaziranga_hotels', [
            ...
            return view('front.hotels_and_resort.kaziranga_hotels', ['kazi_hotels' => $kazi_hotels, 'hotel_name' => $hotel_name, 'hotel' => $hotel, 'setNightsDiff' => $setNightsDiff, 'checked_in' => $checked_in, 'checked_out' => $checked_out, 'setAdultsTotal' => $setAdultsTotal, 'setChildTotal' => $setChildTotal, 'setRoomsTotal' => $setRoomsTotal, 'searching_filter' => $searching_filter, 'allHotels' => $allHotels]);
        }
    }
    ...
    public function hotelDetails(Request $request, $slug)
    {
        ...
        if ($request->searching_filter == "searching2") {
            ...
            return view('front.hotels_and_resort.kaziranga_hotels_details', compact('slug', 'hotel', 'allAmenities', 'hotel_name', 'hotelId', 'hotelRooms', 'setNightsDiff', 'check_in', 'check_out', 'searching_filter', 'allHotels', 'setAdultsTotal', 'setChildTotal', 'setRoomsTotal'));
        } else {
