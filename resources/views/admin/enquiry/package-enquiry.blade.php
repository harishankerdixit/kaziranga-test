...
@section('title', 'Package Enquiry List')
@section('meta_description', 'Kaziranga Booking Package Enquiry List')
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="card my-4 shadow bg-body-tertiary br-1">
            <h3 class="card-header">Package Enquiries</h3>
            <div class="card-body">
                <div class="top_fields">
                    <form method="get" action="{{ route('package-enquiry-list') }}">
                        <div class="row">
                            ...
                            <div class="col-lg-4 d-flex gap-3 my-2">
                                ...
                                <a href="{{ route('package-enquiry-list') }}" class="btn btn-outline-primary">Clear
                                    Filter</a>
                            </div>
                        </div>
                    </form>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <form action="{{ route('package.enquiry.delete', $customer['id']) }}"
                                                        method="POST">
                                                        @method('DELETE')
                                                        @csrf
