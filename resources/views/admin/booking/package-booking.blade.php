...
@section('meta_description', 'Kaziranga Package Booking')
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="card my-4 shadow bg-body-tertiary br-1">
            <h3 class="card-header">Package Booking</h3>
                ...
                <div class="top_fields">
                    <form method="get" action="{{ route('safari-booking', ['type' => 'safari']) }}">
                        <div class="row">
                            ...
                            <div class="col-lg-3  mb-2">
                                ...
                                <select name="filter_booking_type" id="filter_booking_type" class="form-control">
                                    ...
                                    <option value="jungle_trail"
                                        {{ $filter_booking_type == 'jungle_trail' ? 'selected' : '' }}>
                                        Kaziranga Jungle Trail</option>
                            ...
                            <div class="d-flex align-items-end col-lg-3 gap-3 mb-2">
