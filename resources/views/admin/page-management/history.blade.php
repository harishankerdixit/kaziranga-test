...
@section('meta_description', 'History Page')
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="card my-4 shadow bg-body-tertiary br-1">
            <h3 class="card-header">History Page</h3>
            <div class="card-body">
                <form method="post" action="{{ route('page.mangement.history.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group mb-3">
                        <label for="title"><strong>Title</strong></label>
                        <input type="title" class="form-control" id="title" name="title" placeholder="Title"
                            value="{{ old('title', $history_page->title) }}">
                        @error('title')
                            <code>
                                {{ $message }}
                            </code>
                    ...
                    <div class="form-group mb-3">
                        ...
                        @enderror
                        <div>
                            <img id="preview" src="{{ $history_page->path }}" style="margin:10px;max-height:150px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="banner_image_alt" class="form-control" id="banner_image_alt" name="banner_image_alt"
                            ...
                            value="{{ old('banner_image_alt', $history_page->banner_image_alt) }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="meta_title" class="form-control" id="meta_title" name="meta_title"
                            placeholder="Meta Title" value="{{ old('meta_title', $history_page->meta_title) }}">
                        @error('meta_title')
                            <code>
                                {{ $message }}
                            </code>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="meta_description" class="form-control" rows="3" placeholder="Meta Description">{{ old('meta_description', $history_page->meta_description) }}</textarea>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="section_1" class="form-control summernote" rows="3" placeholder="Section">{{ old('section_1', $history_page->section_1) }}</textarea>
                        @error('section_1')
                            <code>
                                {{ $message }}
                            </code>
