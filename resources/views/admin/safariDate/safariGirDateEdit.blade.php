...
@section('title', 'Girnar Edit')
@section('meta_description', 'Kaziranga Manage Safari Date Girnar Edit Page')
@section('content')

<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div>
        <h1> Kaziranga Girnar Edit </h1>

        <form class="row" action="{{ route('date.girnar.hills.update', $date->id) }}" method="POST">
            @method('PUT')
            @csrf
