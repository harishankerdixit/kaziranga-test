...
@section('title', 'Kankai Create')
@section('meta_description', 'Kaziranga Manage Safari Date Kankai Create Page')
@section('content')

<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div>
        <h1> Create Kankai Date </h1>

        <form class="row" action="{{ route('date.kankai.trail.created') }}" method="POST">
            @method('post')
            @csrf
            ...
            <input type="hidden" name="mode" value="kankai">
            <div class="col-md-4">
