...
@section('title', 'Kankai')
@section('meta_description', 'Kaziranga Manage Safari Date Kankai')
@section('content')
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div
          ...
          <h1 class="h2">Kaziranga Kankai Safari</h1>
          <div class="row" style="float: right;">
            <div class="col-sm-6">
              ...
              <div class="col-sm-3">
                <a href="{{ route('date.kankai.trail.create') }}" class=" btn btn-success mt-4">Create Event</a>
              </div>
              <div class="col-sm-3">
        ...
        <div class="top_fields">
          ...
          <form method="get" action="{{ route('getkankaiTrail') }}">
            <div class="row">
              <div class="col-sm-3">
              ...
              <div  class="col-sm-2 mt-4" style="padding-top:10px;">
                <a href="{{ route('getkankaiTrail') }}" class="btn btn-primary">Clear Filter</a>
              </div>
            </div>
          </form>
          ...
          <div class="col-sm-6">
            ...
            <div class="col-sm-2">
              <a href="{{ route('date.jungle.trail.create') }}" class=" btn btn-success mt-4">Create Event</a>
            </div>
            <div class="col-sm-2">
              <button class=" btn btn-success mt-4" onclick="exportCsv();">Export Data</button>
            </div>
                      ...
                      <tr>
                          ...
                          <td>
                              <div class="btn-group" role="group">
                                <a href="{{ route('date.kankai.trail.edit', $date['id']) }}" class="btn btn-warning" style="height: 9%; margin-top: 30%; margin-right: 10%;">
                                  <i class="bi bi-pencil-fill"></i>
                                </a>
                                <form action="{{ route('date.kankai.trail.delete', $date['id']) }}" method="POST">
                                      @method('DELETE')
                                      @csrf
      ...
      <script>
        function checkAvailability(id) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("date.kankai.trail.updateAvailability") }}',
        ...
        function ImportCsv(){
          ...
          $.ajaxSetup({
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("date.kankai.trail.importcsv") }}',
                data: formData,
                processData: false,
                contentType: false,
                success: function (response) {
        ...
        function exportCsv() {
          ...
          $.ajax({
              ...
              success: function (data) {
                  ...
                  var csvFileName = 'kankai_date_' + formattedDate + '.csv';
