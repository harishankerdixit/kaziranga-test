...
@section('title', 'Devalia Edit')
@section('meta_description', 'Kaziranga Manage Safari Date Devalia Edit Page')
@section('content')

<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div>
        <h1> Edit Kaziranga Event </h1>

        <form class="row" action="{{ route('date.devalia.trail.update', $date->id) }}" method="POST">
            @method('PUT')
            @csrf
            ...
            <div class="d-flex gap-3">
                ...
                <a href="{{ route('getdevaliaTrail') }}" class="btn btn-outline-danger col-md-2">Go Back</a>
            </div>
        </form>
    </div>
</main>
