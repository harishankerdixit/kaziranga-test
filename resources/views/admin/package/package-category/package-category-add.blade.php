...
@section('meta_description', 'Kaziranga Package Category Add Page')
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="card my-4 shadow bg-body-tertiary br-1">
            <h3 class="card-header">Add Package Category</h3>
            <div class="card-body">
                        ...
                        <div class="col-sm-10">
                            <div class="row my-0">
                                ...
                                <div class="col my-0">
                                    ...
                                    <input type="text" class="form-control for_sde_price" id="foreigner_adult7"
                                ...
                                <div class="col my-0">
                                    ...
                                    <input type="text" class="form-control for_swe_price" id="foreigner_adult8"
                                ...
                                <div class="col my-0">
                                    ...
                                    <input type="text" class="form-control for_sfe_price" id="foreigner_adult9"
