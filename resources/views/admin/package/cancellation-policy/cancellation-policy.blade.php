...
@section('title', 'Package Cancellation Policy')
@section('meta_description', 'Kaziranga Package Cancellation Policy')
@section('content')
        ...
        <div class="card my-4 shadow bg-body-tertiary br-1">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('cancellationpolicy.add.view.index') }}"
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @forelse ($features as $feature)
                                        <tr>
                                            <td>{{ $feature['id'] }}</td>
                                            <td style="width:80%;">{{ $feature['description'] }}</td>
                                            <td>
                                                <div class="btn-group" role="group"
                                                    aria-label="Basic mixed styles example">
                                                    <a href="{{ route('cancellationpolicy.edit.view', $feature['id']) }}"
                                                        class="btn btn-warning">
                                                        <i class="fa-solid fa-pen"></i>
                                                    </a>
                                                    <a href="{{ route('cancellationpolicy.delete', $feature['id']) }}"
