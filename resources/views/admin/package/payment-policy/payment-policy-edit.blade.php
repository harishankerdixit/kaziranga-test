...
@section('meta_description', 'Kaziranga Edit Package Payment Policy')
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="card my-4 shadow bg-body-tertiary br-1">
            <h3 class="card-header">Edit Package Payment Policy</h3>
            <div class="card-body py-0">
                <form method="post" action="{{ route('paymentpolicy.edit', ['id' => $id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <a href="{{ route('paymentpolicy.list.view') }}" class="btn btn-danger ms-auto px-5 me-2">Back</a>
                    </div>
                </form>
            </div>
        </div>
