...
@section('meta_description', 'Kaziranga Edit Package Festival Date')
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="card my-4 shadow bg-body-tertiary br-1">
            <h3 class="card-header">Edit Package Festival Date</h3>
            <div class="card-body py-0">
                <form method="post" action="{{ route('packagefestivaldates.edit', ['id' => $id]) }}"
